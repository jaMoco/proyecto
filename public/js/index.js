...
// Boton o enlace para ir a la pantalla de inicio de sesion
const loginLink = document.querySelector('.login-link');

// Boton o enlace para ir a la pantalla de registro
const registerLink = document.querySelector('.register-link');

// Boton que abre el popup de inicio de sesion
...
wrapper.classList.remove('active');
 ...
 window.location.href = 'loginForm'; // Cambia '/login' por la ruta correcta en tu aplicación Laravel
});
});
    ...
    if (username && password) {
        Swal.fire({
            ...
            text: `¡Hola, ${username}! Has iniciado sesión correctamente.`,
             ...
             window.location.href = 'inicio.html'; // Redirigir al dashboard o página principal
        });
    } else {
        Swal.fire({
            icon: 'error',
